...
| 4 | Assessment & Report Card | ✅ | Exams, Marks, Grades, Report Card PDF, Raport Interaktif, **CBT**, Item Analysis, **Grading scale/weighting**, **QR verifikasi rapor**, **Grade approval/lock (draft→submitted→approved→locked)** ADA. **MISSING**: Transcript. |
...
5. Transcript (riwayat rapor lintas semester).
