...
const ADMIN_PAGES = [
    ...
    { path: '/admin/my-work',                file: '08-my-work.png',               title: 'My Work' },
    { path: '/admin/academic/years',         file: '09-academic-years.png',        title: 'Academic Years' },
    { path: '/admin/students',               file: '10-students.png',              title: 'Students' },
    { path: '/admin/staff',                  file: '11-staff.png',                 title: 'Staff' },
    { path: '/admin/attendance',             file: '12-attendance.png',            title: 'Attendance' },
    { path: '/admin/timetable',              file: '13-timetable.png',             title: 'Timetable' },
    { path: '/admin/exams',                  file: '14-exams.png',                 title: 'Exams' },
    { path: '/admin/fee/structures',         file: '15-fee-structures.png',        title: 'Fee Structures' },
    { path: '/admin/fee/invoices',           file: '16-fee-invoices.png',          title: 'Fee Invoices' },
    { path: '/admin/payroll/slips',          file: '17-payroll-slips.png',         title: 'Payroll Slips' },
    { path: '/admin/library/books',          file: '18-library-books.png',         title: 'Library Books' },
    { path: '/admin/notices',                file: '19-notices.png',               title: 'Notices' },
    { path: '/admin/chat',                   file: '20-chat.png',                  title: 'Chat' },
    { path: '/admin/ppdb/applications',      file: '21-ppdb-applications.png',     title: 'PPDB Applications' },
    { path: '/admin/achievements/records',   file: '22-achievement-records.png',   title: 'Achievement Records' },
    { path: '/admin/discipline/records',     file: '23-discipline-records.png',    title: 'Discipline Records' },
    { path: '/admin/inventory/assets',       file: '24-inventory-assets.png',      title: 'Inventory Assets' },
    { path: '/admin/reports/spp-aging',      file: '25-reports-spp-aging.png',     title: 'Reports SPP Aging' },
    { path: '/admin/reports/attendance-pct', file: '26-reports-attendance.png',    title: 'Reports Attendance' },
];
