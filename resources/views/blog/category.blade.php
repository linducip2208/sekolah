...
@section('title', $meta['title'] ?? 'Kategori: ' . $category->name)
...
<div class="max-w-7xl mx-auto px-3 sm:px-5 lg:px-6 py-10 sm:py-16 lg:py-20">
    ...
    <div class="text-center mb-12 sm:mb-16">
        ...
        <div class="elite-kicker mb-3">Categoria</div>
        <h1 class="elite-h1 text-4xl sm:text-5xl lg:text-6xl ink-primary mb-4">Kategori: {{ $category->name }}</h1>
        @if($category->description)
            <p class="elite-lead max-w-2xl mx-auto">{{ $category->description }}</p>
        @endif
