 ...
 * navbar / hero style, and — importantly — the background system). Business
 * content lives in a single shared data set (LandingController) and shared
 * Blade components, so adding a template never duplicates copy or markup.
 */
        ...
        return [
            [
                ...
                'vars' => [
                    ...
                    '--lp-surface'        => '#FFFFFF',
                    '--lp-surface-subtle' => '#F7F7FB',
                    '--lp-surface-muted'  => '#F1F1F6',
                    '--lp-surface-brand'  => '#F6F2FF',
                    '--lp-surface-dark'   => '#17123A',
                    '--lp-ink'            => '#1E1B4B',
                    '--lp-muted'          => '#6D6A8A',
                    '--lp-border'         => 'rgba(30, 27, 75, 0.12)',
                    '--lp-hero-glow'      => 'rgba(139, 92, 246, 0.16)',
                    '--lp-pattern-color'  => 'rgba(109, 40, 217, 0.10)',
                ...
                'style' => ['hero' => 'radial', 'navbar' => 'solid', 'card' => 'shadow', 'button' => 'pill', 'pattern' => 'dots'],
            ],
            [
                'key'         => 'corporate',
                'name'        => 'Korporat',
                ...
                'vars' => [
                    ...
                    '--lp-pattern-color'  => 'rgba(30, 64, 175, 0.08)',
                ...
                'style' => ['hero' => 'radial', 'navbar' => 'solid', 'card' => 'shadow', 'button' => 'sharp', 'pattern' => 'grid'],
            ],
            [
                'key'         => 'classic',
                ...
                'vars' => [
                    ...
                    '--lp-background'     => '#f8f5ee',
                    '--lp-surface'        => '#ffffff',
                    '--lp-surface-subtle' => '#f4f0e6',
                    '--lp-surface-muted'  => '#efeae0',
                    '--lp-surface-brand'  => '#f6f1e4',
                    '--lp-surface-dark'   => '#0b1d3a',
                    '--lp-ink'            => '#1a1a1a',
                    '--lp-muted'          => '#6b6660',
                    '--lp-border'         => 'rgba(11, 29, 58, 0.16)',
                    '--lp-hero-glow'      => 'rgba(184, 134, 11, 0.10)',
                    '--lp-pattern-color'  => 'rgba(11, 29, 58, 0.06)',
                    '--lp-pattern-opacity' => '0.5',
                    '--lp-radius-sm'      => '4px',
                    '--lp-radius-md'      => '8px',
                    '--lp-radius-lg'      => '12px',
                ...
                'style' => ['hero' => 'radial', 'navbar' => 'solid', 'card' => 'bordered', 'button' => 'sharp', 'pattern' => 'grid'],
            ],
            [
                'key'         => 'minimal',
                'name'        => 'Minimalis',
                ...
                'vars' => [
                    ...
                    '--lp-background'     => '#FFFFFF',
                    '--lp-surface'        => '#FFFFFF',
                    '--lp-surface-subtle' => '#FAFAFA',
                    '--lp-surface-muted'  => '#F4F4F5',
                    '--lp-surface-brand'  => '#F8F8F8',
                    '--lp-surface-dark'   => '#0F172A',
                    '--lp-ink'            => '#0F172A',
                    '--lp-muted'          => '#64748B',
                    '--lp-border'         => 'rgba(15, 23, 42, 0.10)',
                    '--lp-hero-glow'      => 'rgba(51, 65, 85, 0.04)',
                    '--lp-pattern-color'  => 'rgba(15, 23, 42, 0.05)',
            ...
            [
                ...
                'vars' => [
                    ...
                    '--lp-background'     => '#f7f5ef',
                    '--lp-surface'        => '#ffffff',
                    '--lp-surface-subtle' => '#f2efe6',
                    '--lp-surface-muted'  => '#ece8dc',
                    '--lp-surface-brand'  => '#eef5ec',
                    '--lp-surface-dark'   => '#10301f',
                    '--lp-ink'            => '#1c2a22',
                    '--lp-muted'          => '#5f6b62',
                    '--lp-border'         => 'rgba(20, 83, 45, 0.16)',
                    '--lp-hero-glow'      => 'rgba(184, 134, 11, 0.10)',
                    '--lp-pattern-color'  => 'rgba(20, 83, 45, 0.08)',
                    '--lp-pattern-opacity' => '0.6',
                    '--lp-radius-sm'      => '8px',
                    '--lp-radius-md'      => '12px',
                    '--lp-radius-lg'      => '16px',
                ...
                'style' => ['hero' => 'radial', 'navbar' => 'solid', 'card' => 'bordered', 'button' => 'rounded', 'pattern' => 'geometric'],
            ],
        ];
    }
}
