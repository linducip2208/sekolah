...
class ClassroomController extends Controller
{
    ...
    {
        StudyMaterial::where('school_id', auth()->user()->school_id)->findOrFail($materialId)->delete();
    ...
    public function assignments(Request $request): JsonResponse
    {
        ...
        $lesson = Lesson::where('school_id', auth()->user()->school_id)->findOrFail($request->lesson_id);
